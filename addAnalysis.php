    ...
    <div id="main-header">
        <div id="main-header-container">
            ...
            <div id="main-header-left">
                ...
                <h1 class="header-title">Kan Tahlili Ekle</h1>
            </div>
        ...
        <form class="add-analysis-form" action="?" method="POST">
            <table class="new-analysis-table">
                <div class="date-id-count-container">
                    ...
                    <div class="name-surname-container"> <h3>Kullanıcı Adı-Soyadı</h3> <?= $user["nameSurname"]?> </div>
                    <div class="pet-name-container"> <h3>Hayvanın Adı</h3> <?= $user["petName"]?> </div>
                    <div class="pet-type-container">  <h3>Hayvanın Türü</h3>  <?= $user["animalType"]?> </div>
                ...
                <div class="analysis-row">
                    <div colspan="3">
                        <button type="submit" class="save-btn" title="Tahlil Ekle">
                            <h3>Kaydet</h3> 
                        </button>
                    </div>
                </div>
